...
public class ColorPane extends JTextPane {
  ...
  static final Color D_Red = Color.getHSBColor(new Float(0.000),new Float(1.000),new Float(0.502));
  static final Color D_Blue = Color.getHSBColor(new Float(0.667),new Float(1.000),new Float(0.502));
  static final Color D_Magenta = Color.getHSBColor(new Float(0.833),new Float(1.000),new Float(0.502));
  static final Color D_Green = Color.getHSBColor(new Float(0.333),new Float(1.000),new Float(0.502));
  static final Color D_Yellow = Color.getHSBColor(new Float(0.167),new Float(1.000),new Float(0.502));
  static final Color D_Cyan = Color.getHSBColor(new Float(0.500),new Float(1.000),new Float(0.502));
  static final Color D_White = Color.getHSBColor(new Float(0.000),new Float(0.000),new Float(0.753));
  static final Color B_Black = Color.getHSBColor(new Float(0.000),new Float(0.000),new Float(0.502));
  static final Color B_Red = Color.getHSBColor(new Float(0.000),new Float(1.000),new Float(1.000));
  static final Color B_Blue = Color.getHSBColor(new Float(0.667),new Float(1.000),new Float(1.000));
  static final Color B_Magenta = Color.getHSBColor(new Float(0.833),new Float(1.000),new Float(1.000));
  static final Color B_Green = Color.getHSBColor(new Float(0.333),new Float(1.000),new Float(1.000));
  static final Color B_Yellow = Color.getHSBColor(new Float(0.167),new Float(1.000),new Float(1.000));
  static final Color B_Cyan = Color.getHSBColor(new Float(0.500),new Float(1.000),new Float(1.000));
  static final Color B_White = Color.getHSBColor(new Float(0.000),new Float(0.000),new Float(1.000));
